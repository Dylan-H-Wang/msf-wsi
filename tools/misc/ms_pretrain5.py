...
instead, it contrast only their concatenations. (same as ms_pretrain2.py)

Data augmentation strategy is random masking out pre-defined ratio of target patches.
"""
...
def main_worker(gpu, ngpus_per_node, arg):
    ...
    if args.data_name == "hubmap":
        ...
        train_dataset = BcssPretrainDatasetMS5(
            args.data,
            (
                albu.Compose(context_aug),
                albu.Compose(target_aug),
