...
def main_worker(gpu, ngpus_per_node, args):
    ...
    train_dataset = PaipSegDataset(args.train_data, train_aug, frac=args.frac)
    ...
    val_dataset = PaipSegDatasetVal(args.val_data, val_aug)
...
def validate(loader, model, epoch, args):
    ...
    with torch.no_grad():
        ...
        for i, (images, masks) in enumerate(loader):
            ...
            with autocast(enabled=args.amp):
                _, target_logits_mask = model(images)
