...
def main_worker(gpu, ngpus_per_node, arg):
    ...
    context_aug = [
        ...
        albu.ToGray(p=0.2),
        albu.OneOf(
            [albu.GaussianBlur(blur_limit=[19, 23], sigma_limit=[0.1, 2.0], p=0.5), albu.Sharpen(p=0.5)],
            p=0.5,
        ),
    ...
    elif args.data_name == "camelyon16_all":
        train_dataset = Camelyon16PretrainDataset(
            data_path=args.data,
            transforms=(
                albu.Compose(context_aug),
...
if __name__ == "__main__":
    ...
    # Log setting
    parser.add_argument("--logger-name", default="DSF-WSI", type=str)
    ...
    parser.add_argument("--use-ac", action="store_true", help="use activation checkpoint")
