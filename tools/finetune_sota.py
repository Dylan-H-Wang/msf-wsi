...
from src.utils.data.camelyon import Camelyon16SegDataset, Camelyon16SegDatasetVal
...
def main_worker(gpu, ngpus_per_node, args):
    ...
    if os.path.isfile(args.weights):
        ...
        logger.warning(f"=> Train model from the scratch!")
        # sys.exit(1)
