...
def main_worker(gpu, ngpus_per_node, args):
    ...
    if os.path.isfile(args.weights):
        ...
        logger.info(f"=> no pretrained weights found at {args.weights}")
        if args.imagenet:
            logger.info(f"=> initialise encoder with ImageNet weights")
        else:
            logger.info(f"=> initialise encoder with random weights")
